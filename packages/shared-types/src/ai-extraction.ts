...
export const PRODUCT_SUBCATEGORY_OPTIONS = [
  ...
  "KIDS_SHOES",
  "OFFICIAL_SHOES",
  "CROSSBODY_BAG", "SHOULDER_BAG", "HANDBAG", "TOTE_BAG", "BACKPACK", "CLUTCH_BAG", "WAIST_BAG",
  "LADIES_BAGS",
  "SCHOOL_BAGS",
  "PACKAGE_BAGS",
  "HATS_CAPS",
...
> = {
  KIDS: ["KIDS_DRESS", "KIDS_JACKET_TOP", "KIDS_TOPS", "KIDS_HOODIES", "KIDS_SKIRTS", "KIDS_PANTS", "KIDS_SHORTS", "KIDS_SETS", "KIDS_PYJAMAS", "NEWBORN", "OTHER"],
  PANTS: ["MEN_JEANS", "WOMEN_JEANS", "LADIES_PANTS_MIX", "SWEAT_PANTS", "CARGO_PANTS", "OFFICIAL_PANTS", "LEGGINGS", "WIDE_LEG_PANTS", "OTHER"],
  JACKETS: ["MEN_JACKETS", "THICK_VEST", "LADIES_JACKETS", "UNISEX_JACKETS", "HOODIES", "SWEATSHIRTS", "DENIM_JACKETS", "BLAZERS", "PUFFER_JACKETS", "WINDBREAKERS", "RAIN_JACKETS", "COATS", "CARDIGANS", "KNITWEAR", "SUITS", "OTHER"],
  ...
  TWO_PIECE: ["LONG_TWO_PIECE", "SHORT_TWO_PIECE", "TRACKSUITS", "OTHER"],
  SHOES: ["MEN_SPORT_SHOES", "MEN_SHOES", "LADIES_SHOES", "KIDS_SHOES", "OFFICIAL_SHOES", "OTHER"],
  BAG: ["CROSSBODY_BAG", "SHOULDER_BAG", "HANDBAG", "TOTE_BAG", "BACKPACK", "CLUTCH_BAG", "WAIST_BAG", "TRAVEL_BAG", "WALLET", "SCHOOL_BAGS", "OTHER"],
  OTHERS: ["HATS_CAPS", "SCARFS", "BELTS", "SUNGLASSES", "WATCHES", "JEWELLERY", "HAIR_ACCESSORIES", "GLOVES", "BODY_SHAPERS", "INNER_WARES", "SWIMWEAR", "OTHER"],
  TEXTILE: ["BEDSHEETS", "LIGHT_BLANKETS", "CURTAINS", "OTHER"],
  OTHER: ["OTHER"]
};
