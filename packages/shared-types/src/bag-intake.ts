export const BAG_STYLES = ["CROSSBODY_BAG", "SHOULDER_BAG", "HANDBAG", "TOTE_BAG", "BACKPACK", "CLUTCH_BAG", "WAIST_BAG", "OTHER"] as const;
export const BAG_STYLE_LABELS: Record<string, string> = {
  CROSSBODY_BAG: "斜挎包", SHOULDER_BAG: "单肩包", HANDBAG: "手提包", TOTE_BAG: "托特包",
  BACKPACK: "双肩包", CLUTCH_BAG: "手拿包", WAIST_BAG: "腰包", OTHER: "其他"
};
