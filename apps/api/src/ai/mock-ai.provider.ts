...
export class MockAIProvider implements AIProvider {
  async extract(request: AIExtractionRequest): Promise<AIProviderResult> {
    ...
    const normalizedOutput: AIExtractionNormalizedOutput = {
      ...
      fitType: { value: "REGULAR" as const, confidence: 0.78, evidenceImageIds },
      stretchLevel: { value: "LOW" as const, confidence: 0.64, evidenceImageIds },
      fabricWeight: { value: "REGULAR" as const, confidence: 0.72, evidenceImageIds },
